...
@WebServlet("/PrendiCanzoniDaIdPlaylist")
public class PrendiCanzoniDaIdPlaylist extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException ,ServletException
	{
		...
		Set<Canzone> list_canzoni = canzoneDao.getCanzoniDaPlaylist(Long.parseLong(request.getParameter("idPlaylist")));
